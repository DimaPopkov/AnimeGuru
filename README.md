...
[
    {
        ...
        "season": "YYYY-MM-DD" (Дата начала выхода тайтла) (null=True),
        ...
        "pics_name": ["Название", Количество] (Фотографии для слайдера, должны храниться в media\img\pics и иметь названия "название_pic1" \ "название_pic2" и т.п.) (Количество - число фотографий добавленных в папку media для текущего тайтла) (null=True)
    }
]
```
